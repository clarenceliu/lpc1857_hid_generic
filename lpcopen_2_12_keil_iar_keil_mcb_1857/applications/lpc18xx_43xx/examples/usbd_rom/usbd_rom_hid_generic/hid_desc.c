...
#define HID_INPUT_REPORT_BYTES       255				/* size of report in Bytes */
#define HID_OUTPUT_REPORT_BYTES      255				/* size of report in Bytes */
#define HID_FEATURE_REPORT_BYTES     255				/* size of report in Bytes */
